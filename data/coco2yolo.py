...
python data/coco2yolo.py --json_path ~/fast-data/coco/annotations/instances_train2017.json --save_path ~/fast-data/coco/train2017/
"""
...
parser.add_argument('--json_path', default='./instances_val2017.json',
                    type=str, help="input: coco format(json)")
parser.add_argument('--save_path', default='./labels', type=str,
